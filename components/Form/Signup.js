// Register Form Not included any where
    ...
    <div>
      ...
      <div className="flex flex-wrap -mx-3 mb-6">
        <div className="w-full px-3">
          ...
          <input name="confirm password" className="appearance-none block w-full bg-gray-200 text-gray-700 border border-gray-200 rounded py-3 px-4 mb-3 leading-tight focus:outline-none focus:bg-white focus:border-gray-500" id="grid-confirm-password" type="password" />
          {/* <p className="text-gray-600 text-xs italic">Enter a Valid Email</p> */}
        </div>
      </div>
